...
img1 = cv2.imread('/Users/apple/Desktop/ENSTA/apprentissage/3A/ROB317/TP/TP1/TP1_Features/Image_Pairs/torb_small1.png')
print("Dimension de l'image 1 :",img1.shape[0],"lignes x",img1.shape[1],"colonnes")
print("Type de l'image 1 :",img1.dtype)
img2 = cv2.imread('/Users/apple/Desktop/ENSTA/apprentissage/3A/ROB317/TP/TP1/TP1_Features/Image_Pairs/torb_small2.png')
